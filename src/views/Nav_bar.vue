<template>
  <div
    class="h-16 fixed top-0 left-0 w-[100vw] bg-white z-50 flex items-center justify-between dark:bg-black"
  >
    <div class="md:hidden lg:block flex ml-5">
      <svg
        class="md:ml-4 cursor-pointer dark:text-white"
        height="26px"
        viewBox="0 0 24 24"
        width="26px"
    ...
    <div class="hidden md:flex justify-center w-[50%] text-sm ml-10">
      <div class="gap-20 flex justify-center text-gray-600">
        <div class="flex flex-col">
          <svg
            class="cursor-pointer text-black pointer-events-auto dark:text-white"
            height="25px"
            viewBox="0 0 24 24"
            width="25px"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex flex-col">
          <svg
            class="text-black cursor-pointer pointer-events-auto dark:text-white"
            height="25px"
            viewBox="0 0 24 24"
            width="25px"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div
      class="hidden xl:flex p-2 bg-gray-200 dark:bg-slate-50 items-center rounded-xl"
    >
      <input
        type="text"
        placeholder="search..."
    ...
    <div
      class="w-[40%] md:justify-end flex items-center gap-4 xl:gap-2 justify-evenly"
    >
      <div class="flex items-center gap-2 text-sm">
        <svg
          class="md:mr-4 text-black cursor-pointer dark:text-white"
          xmlns="http://www.w3.org/2000/svg"
          width="25px"
          height="25px"
          viewBox="0 0 24 24"
      ...
      <div class="md:hidden cursor-pointer" @click="toggleTheme">
        <svg
          v-if="!isIconSwitched"
          class="text-black cursor-pointer pointer-events-auto dark:text-white"
          width="25px"
        ...
        <svg
          v-else
          class="text-black cursor-pointer dark:text-white"
          width="25px"
          height="25px"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
  ...
  methods: {
    toggleTheme(event: MouseEvent) {
      ...
      transition.ready.then(() => {
        ...
        this.isIconSwitched = !this.isIconSwitched;
      });
    },
  },
});
