<template>
  <div class="md:hidden cursor-pointer pointer-events-auto">
    ...
    >
      <div
        :class="[
          'w-6  h-1 bg-black rounded-sm dark:bg-white',
          isOpen ? 'rotate-45' : '',
    ...
    <div
      v-if="isOpen"
      class="absolute left-0 top-12 w-full h-[calc(100vh-48px)] bg-white flex flex-col items-center justify-center gap-8 font-medium text-xl z-10 dark:bg-black"
    >
      <router-link
        :class="menuClass"
